...
public class UCSBOrganizationIT {
        ...
        public void an_admin_user_can_post_a_new_organization() throws Exception {
                ...
                UCSBOrganization organization1 = UCSBOrganization.builder()
                                .orgCode("GDC")
                                .orgTranslationShort("GameDev")
                                .orgTranslation("GameDevelopment")
                                .inactive(false)
                                .build();

                // act
                MvcResult response = mockMvc.perform(
                                post("/api/ucsborganization/post?orgCode=GDC&orgTranslationShort=GameDev&orgTranslation=GameDevelopment&inactive=false")
                                                .with(csrf()))
